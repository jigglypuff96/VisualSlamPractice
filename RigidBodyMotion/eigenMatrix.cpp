...
//    cout <<"time use in normal inverse is " << 1000* (clock() - time_stt)/(double)CLOCKS_PER_SEC << "ms"<< endl;
    ...
    cout << "For non-symmetric square problems we need to use a direct solver based on LU or BICGSTAB in the world of iterative solvers." << endl;
    time_stt = clock();
